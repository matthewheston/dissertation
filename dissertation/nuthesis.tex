...
Same State &  &  & 0.064 & 0.063 \\ 
 ...
 Constant & 6.601$^{***}$ & 6.735$^{***}$ & 6.925$^{***}$ & 6.948$^{***}$ \\ 
  ...
  & & & & \\ 
\hline \\[-1.8ex] 
\\[-1.8ex] & \multicolumn{4}{c}{Random Effects} \\ 
\hline \\[-1.8ex] 
 $\sigma_{participant}$ & 0.760 & 0.834 & 0.809 & 0.780 \\
 $\sigma_{contact}$ & 1.673 & 1.676 & 1.684 & 1.694 \\
 $\epsilon$ & 2.585 & 2.462 & 2.462 & 2.443 \\
 \hline \\[-1.8ex] 
 \hline \\[-1.8ex] 
