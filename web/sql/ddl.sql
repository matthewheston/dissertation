...
CREATE TABLE `SurveyResult` (`uid` INTEGER PRIMARY KEY AUTO_INCREMENT NOT NULL, `availability` INTEGER NOT NULL, `urgency` INTEGER NOT NULL, `friend_urgency` INTEGER NOT NULL, `unavailability` BOOLEAN, `message_id` INTEGER NOT NULL, `participant_id` TEXT, `puid` INT);
