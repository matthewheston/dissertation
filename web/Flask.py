...
def process_form(participant_id):
    ...
    for contact in contacts:
        ...
        result.intimacy1 = request.form.get("intimacy1- " + contact, 0)
        result.intimacy2 = request.form.get("intimacy2- " + contact, 0)
        result.intimacy3 = request.form.get("intimacy3- " + contact, 0)
        result.power1 = request.form.get("power1- " + contact, 0)
        result.power2 = request.form.get("power2- " + contact, 0)
        result.power3 = request.form.get("power3- " + contact, 0)
        result.distance= request.form.get("distance- " + contact, 0)
